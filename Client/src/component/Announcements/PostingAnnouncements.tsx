...
// import { Container, Heading, Text, Select, Input, Textarea,Button, position } from '@chakra-ui/react'
...
//     <LeftBar />
//       <Container maxW="1190px" ml="220px">
//       <Container ml="auto">
//           <Select fontWeight='700' width='229px' placeholder='Select Class'>
...
//         </Container>
//       <div>
//         <Heading fontSize='25px'>Compose Announcement</Heading>
...
//       </div>
//       <div>
//       <Button backgroundColor='black' width='229px'  fontSize='15' color='white'>POST</Button>
//       </div>
//       </Container> 
//     </div>
//   )
...
// import React from 'react';
// import { Container, Heading, Text, Select, Input, Textarea, Button } from '@chakra-ui/react';
// import LeftBar from '../SideBar/LeftBar';
